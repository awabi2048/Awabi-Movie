...
execute if data storage awabi_movie:temp DisplayData[0] run tellraw @s [{"text": "- ","color": "gray"},{"text": "Name: ","color": "white"},{"nbt":"DisplayData[0].Name","storage": "awabi_movie:temp","color": "white"},{"text": " (Id: ","color": "gray"},{"nbt":"DisplayData[0].Id","storage": "awabi_movie:temp"},{"text": ")","color": "gray"}]
