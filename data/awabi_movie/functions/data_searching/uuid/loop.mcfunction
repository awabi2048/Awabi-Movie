...
execute store success storage awabi_movie:temp DataSearching.Memory.CompareFailed byte 1 run data modify storage awabi_movie:temp DataSearching.Memory.CompareTarget.OwnerUUID set from storage awabi_movie:temp DataSearching.TargetData
